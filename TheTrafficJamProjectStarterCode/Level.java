...
public class Level {	
	...
	public boolean passedLevel() {
		...
		System.out.println("Win Location X: " + winLocation.getRow());
		System.out.println("Win Location Y: " + winLocation.getCol());

		
		if (board.getVehicleAt(winLocation) != null) {
			if (board.getVehicleAt(winLocation).getVehicleType() == VehicleType.MYCAR) {
				return true;
			}
		}
